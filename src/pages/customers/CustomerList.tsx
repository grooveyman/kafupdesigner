...
const CustomerList: React.FC = () => {
    ...
    const { data, isLoading } = useApiQuery<CustomerResponseType>(["customers"], "/customers/all/DES740410");
    ...
    const filteredData = useMemo(() => {
        ...
        return data.data.filter((customer: any) => {
            const matchesSearch =
                                                ...
                                                >
                                                    ...
                                                    <td>
                                                        <div className="d-flex gap-3">
                                                            <User />
                                                            <div className="prod-det">{customer.name}</div>
                                                        </div>
                                                    </td>
                                                        ...
                                                        <div className="d-flex justify-content-start align-items-center">
                                                            ...
                                                            <div className="d-block d-md-none" style={{ position: "relative" }}>
                                                                ...
                                                                {openDropdown === customer.id && (
                                                                    <div style={{
                                                                        ...
                                                                        <div style={{ padding: "8px", cursor: "pointer" }} onClick={() => handleDropdownAction("view", customer)}>View</div>
                                                                        <div style={{ padding: "8px", cursor: "pointer" }} onClick={() => handleDropdownAction("ship", customer)}>Ship</div>
                                                                        <div style={{ padding: "8px", cursor: "pointer", color: "red" }} onClick={() => handleDropdownAction("delete", customer)}>Cancel</div>
                                                                    </div>
                                                                )}
                                                            </div>
                                                            ...
                                                            <div className="d-none d-md-flex gap-2">
                                                                <EyeIcon
                                                                    ...
                                                                    onClick={() => handleDropdownAction("view", customer)}
                                                                />
                                                                <Mail
                                                                    className="prod-action-edit"
                                                                    style={{ cursor: "pointer" }}
                                                                    size={22} strokeWidth={1.3}
                                                                    onClick={() => handleDropdownAction("ship", customer)}
                                                                />
