...
const AddProducts: React.FC = () => {
    ...
    const { data, isLoading } = useApiQuery<ProductType>(["editproduct_" + prodid], `/designs/product/${prodid}`);
    ...
    useEffect(() => {
        ...
        if (data) {
            addToProduct(data);
            addToProduct({ designer_code: "DES740410" });
            // console.log(data);
        }
    }, [data, addToProduct]);
    // addToProduct(data);
    ...
    const productSchema = z.object({
        ...
        description: z.string().transform((value) => value.replace(/[^a-zA-Z0-9\s]/g, '')).nullable(),
        price: z.string(),
